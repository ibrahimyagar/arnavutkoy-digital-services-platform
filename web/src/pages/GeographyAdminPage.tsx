  ...
  return (
    <div className="container stack">
      <div>
        ...
        <p className="muted">İlçe → mahalle → sokak hiyerarşisini yönetin.</p>
      </div>
                  ...
                  >
                    <span>
                      ...
                      <small className="muted" style={{ display: 'block' }}>
                        Muhtar: {n.headmanFullName || '—'} · Nüfus {n.population}
                      </small>
                    </span>
                  </button>
                </li>
              ))}
              {neighborhoods.length === 0 ? <li className="muted">Bu ilçede mahalle yok.</li> : null}
            </ul>
        ...
        {!neighborhoodId ? (
          ...
          <>
            <ul className="stack" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {streets.map((s) => (
                <li key={s.id} style={{ padding: '0.35rem 0', borderBottom: '1px solid var(--line)' }}>
                  {s.name}
                </li>
              ))}
              {streets.length === 0 ? <li className="muted">Bu mahallede sokak yok.</li> : null}
            </ul>
