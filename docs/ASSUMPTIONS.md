...
**Karar:** İlk sürümde 5 bounded context **tam derinlikte** uygulanır: `Identity`, `Geography`, `Announcements`, `CitizenRequests`, `Payments`. Yol haritası: R1 Street, R2 Properties, R3 UtilitySubscriptions tamamlandı; kalan (`Hr`, `SocialAssistance`, `Transportation`) aynı derinlikle devam eder.
