...
**Karar:** İlk sürümde 5 bounded context **tam derinlikte** uygulanır: `Identity`, `Geography`, `Announcements`, `CitizenRequests`, `Payments`. Yol haritası: R1–R4 (Street, Properties, UtilitySubscriptions, Hr) tamamlandı; kalan (`SocialAssistance`, `Transportation`) aynı derinlikle devam eder.
